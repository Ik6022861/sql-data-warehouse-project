	...
	BEGIN TRY
		...
		SELECT 
			...
			CASE WHEN UPPER(TRIM(cst_gndr)) = 'M' THEN 'Male'
				 ...
				 ELSE 'n/a'
			END AS cst_gndr, -- Normalization gender values to readable format
			cst_create_date 
		FROM 
		(
			SELECT 
		...
		PRINT ' - Total Silver Layer Load Duration '+ CAST(DATEDIFF(second, @start_batch_time, @end_batch_time) AS NVARCHAR) + ' seconds';
		PRINT '===============================================';
